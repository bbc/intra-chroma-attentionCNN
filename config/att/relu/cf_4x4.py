...
output_path = "/work/marcb/Intra_Chroma/experiments/att_relu"
data_path = "/work/marcb/data/DIV2K/0.60-1000-1"

# Model parameters
model = 'relu'               # [relu, norelu]
block_shape = '4x4'          # block shape of the model
bb1, bb2 = 16, 32            # channels of the 2 boundary branch layers
lb1, lb2 = 32, 32            # channels of the 2 luma convolutional branch layers
tb = 32                      # channels of the predicted head
